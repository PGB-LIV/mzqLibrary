...
public class MzqLib {
    ...
    public MzqLib(final String typeStr, final String mzqFile, final String outputFile) {
        ...
        if (type == 0) {
            System.out.println("Unrecognized converter type. Please use one value in the collection of "
...
//      <xsd:element name="StudyVariableList" type="StudyVariableListType" minOccurs="0" maxOccurs="1"/>
        ...
        Iterator<PeptideConsensusList> peptideConsensusLists =
            unmarshaller.unmarshalCollectionFromXpath(MzQuantMLElement.PeptideConsensusList);
