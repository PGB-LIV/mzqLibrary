...
public class FeatureListHeaders {
    ...
    /**
     * The heading of "raw abundance".
     */
    public static final String RAW_ABUNDANCE = "raw abundance";

    /**
     * The heading of "intensity".
     */
    public static final String INTENSITY = "intensity";

    /**
     * The heading of "sample retention time".
     */
    ...
    /**
     * The heading of "retention time (min)".
     */
    ...
    /**
     * The heading of "score".
     */
    public static final String SCORE = "score";

    /**
     * The heading of "modifications".
     */
    public static final String MODIFICATIONS = "modifications";

    /**
     * The heading of "sequence".
     */
    public static final String SEQUENCE = "sequence";

    /**
     * The heading of "protein".
     */
    public static final String PROTEIN = "protein";

    /**
     * The heading of "accession".
     */
