...
//        final String out_file = "../itraq/ksl_itraq_result_proteinAbundance.mzq";
        ...
        String out_file = "test_grouping_data_proteinAbundance_" + abunOperation + ".mzq";
...
//                        sumOfpepValues[j] = sumOfpepValues[j] + temp;
            ...
            List<String> proteinAbundanceList = Arrays.asList(Arrays.toString(operationPepValues));
